...
`fm-spawn` also binds a canonical Bun runtime for OMP composer geometry; script-backed entrypoints launch through that runtime, while compiled OMP executables launch directly.
